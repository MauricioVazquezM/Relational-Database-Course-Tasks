...
---PREGUNTA 1: Qué contactos de proveedores tienen la posición de sales representative?
...
---PREGUNTA 3: Cuales órdenes no vienen de clientes en Estados Unidos?
...
---PREGUNTA 6: Qué órdenes van a LATAM?
select * from orders o; 
...
---PREGUNTA 11: Obtener un reporte de edades de los empleados para checar su elegibilidad para seguro de gastos médicos menores.
select * from employees e;
...
---PREGUNTA 14: Cuántos productos tenemos de cada categoría?
select * from products p;
...
---PREGUNTA 15: Cómo podemos generar el reporte de reorder?
select * from products p;
